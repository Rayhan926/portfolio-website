...
!(function (t, e) {
  ...
  function Z(t) {
    ...
    for (r = t.length; r--; )
      (t[r] && (t[r]._gsap || (t[r]._gsap = new It(t[r], e)))) ||
        t.splice(r, 1);
    return t;
  }
  function $(t) {
  ...
  function la(t, e) {
    for (var r in e) t[r] = s(e[r]) ? la(t[r] || (t[r] = {}), e[r]) : e[r];
    return t;
  }
  function ma(t, e) {
    var r,
  ...
  function Ha(t, e, r, i) {
    ...
    return (
      ...
      (t._dur = a),
      (t._tDur = n ? (n < 0 ? 1e10 : ba(a * (n + 1) + t._rDelay * n)) : a),
    ...
    return (
      ...
      function (t, e, r) {
        var i,
          ...
          p = v[d];
        if (!p) {
          if (!(f = "auto" === _.grid ? 0 : (_.grid || [1, H])[1])) {
            for (
              h = -H;
          ...
          for (
            ...
            (a = (u % f) - i),
              (s = n - ((u / f) | 0)),
              (p[u] = o = b ? Math.abs("y" === b ? s : a) : j(a * a + s * s)),
              h < o && (h = o),
              o < l && (l = o);
          "random" === m && Ta(p),
            (p.max = h - l),
  ...
  function cb(t) {
    for (var e, r, i, n, a = 0, s = ""; ~(e = t.indexOf("random(", a)); )
      (i = t.indexOf(")", e)),
        ...
        (s +=
          t.substr(a, e - a) + Xa(n ? r : +r[0], n ? 0 : +r[1], +r[2] || 1e-5)),
        (a = i + 1);
  ...
  function nb(t, e, r) {
    var i,
      ...
      f,
      d,
      p = t ? (q(t) ? [t >> 16, (t >> 8) & kt, t & kt] : 0) : Ot.black;
    if (!p) {
      if (("," === t.substr(-1) && (t = t.substr(0, t.length - 1)), Ot[t]))
        ...
        if (((p = d = t.match(et)), e)) {
          if (~t.indexOf("="))
            return (p = t.match(rt)), r && p.length < 4 && (p[3] = 1), p;
        } else
          (s = (+p[0] % 360) / 360),
            (o = p[1] / 100),
            (i =
        ...
        wake: function wake() {
          l &&
            (!n &&
              ...
              L(h || i.GreenSockGlobals || (!i.gsap && i) || {}),
  ...
  var Et = (function (n) {
    ...
    return (
          ...
          if (
            ...
            if (
              ...
              if (
                ...
                (c = b ? 0 : g),
                (this._lock = 1),
                (this.render(c || (_ ? 0 : ba(s * o)), e, !g)._lock = 0),
      ...
      (e.add = function add(t, e) {
        var r = this;
        if ((q(e) || (e = Ka(this, e)), !(t instanceof Lt))) {
          if (tt(t))
            return (
              t.forEach(function (t) {
                return r.add(t, e);
      ...
      (e.addPause = function addPause(t, e, r) {
        ...
        return (
          (i.data = "isPause"), (this._hasPause = 1), Ba(this, i, Ka(this, t))
        );
      }),
            ...
            ia(
              {
                ...
                onStart: function onStart() {
                  ...
                  u._dur !== t && Ha(u, t, 0, 1).render(u._time, !0, !0),
                    a && a.apply(u, s || []);
                },
              },
              e
      ...
      (e.tweenFromTo = function tweenFromTo(t, e, r) {
        return this.tweenTo(e, ia({ startAt: { time: Ka(this, t) } }, r));
      }),
        ...
        if (a._dirty) {
          for (i = a.parent; s; )
            (e = s._prev),
              ...
              (s = e);
          Ha(a, a === I && a._time > n ? a._time : n, 1, 1), (a._dirty = 0);
        }
        return a._tDur;
      }),
      (Timeline.updateRoot = function updateRoot(t) {
        if ((I._ts && (fa(I, xa(t, I)), (f = Ct.frame)), Ct.frame >= pt)) {
          pt += Y.autoSleep || 120;
          var e = I._first;
        ...
        (u = new ft[t]()).init(
          ...
          u.rawVars
            ...
            : (function _processVars(t, e, r, i, n) {
                if (
                  (p(t) && (t = Xt(t, n, e, r, i)),
                  !s(t) || (t.style && t.nodeType) || tt(t) || J(t))
                )
  ...
  var Nt,
    ...
    Yt = function _initTween(e, r) {
      ...
      if (
        ...
        if (
          ((_ = (l = S[0] ? $(S[0]).harness : 0) && m[l.prop]),
          (i = ma(m, ut)),
          A && A.render(-1, !0).kill(),
          v)
        ) {
    ...
    Vt = (function (A) {
      function Tween(e, r, i, n) {
        ...
        var o,
          ...
          O = c.yoyoEase,
          M = a.parent,
          C = (tt(e) || J(e) ? q(e[0]) : "length" in r) ? [e] : Tt(e);
        if (
          ((a._targets = C.length
            ? Z(C)
            : N(
          ...
          if (
            ...
            if (((l = C.length), (p = b ? Ua(b) : P), s(b)))
              for (f in b) ~Ht.indexOf(f) && ((_ = _ || {})[f] = b[f]);
            for (u = 0; u < l; u++) {
              ...
              (h.stagger = 0),
                ...
                _ && mt(h, _),
                (d = C[u]),
                (h.duration = +Xt(m, _assertThisInitialized(a), u, d, C)),
                (h.delay =
                  (+Xt(g, _assertThisInitialized(a), u, d, C) || 0) - a._delay),
                !b &&
                  1 === l &&
                  h.delay &&
      ...
      return (
          ...
          if (_) {
            if (
              ...
              if (((i = c), (l = this.timeline), this._repeat)) {
                if (((s = _ + this._rDelay), this._repeat < -1 && t < 0))
                ...
                a !== o &&
                  ...
                  !this.vars.repeatRefresh ||
                    ...
                    this._lock ||
                    ((this._lock = r = 1),
                    (this.render(ba(s * a), !0).invalidate()._lock = 0)));
              }
              if (!this._initted) {
        ...
        (e.kill = function kill(t, e) {
          if ((void 0 === e && (e = "all"), !(t || (e && "all" !== e))))
            return (this._lazy = this._pt = 0), this.parent ? hb(this) : this;
          if (this.timeline) {
            ...
            return (
              ...
              this.parent &&
                ...
                Ha(this, (this._dur * this.timeline._tDur) / r, 0, 1),
              this
            );
          }
          var i,
  ...
  ia(Vt.prototype, { _targets: [], _lazy: 0, _startAt: 0, _op: 0, _onInit: 0 }),
  ...
  var ne = {
    ...
    registerEffect: function registerEffect(t) {
      ...
      (e || "").split(",").forEach(function (t) {
        return (
          t && !ft[t] && !ot[t] && N(i + " effect requires " + t + " plugin.")
        );
      }),
        (dt[i] = function (t, e, r) {
  ...
  function rd(e) {
    ...
    return (
      (r && (r.width || r.height)) || e.getBBox === pd || (r = pd.call(e, !0)),
      !r || r.width || r.x || r.y
        ? r
        : {
            x: +qd(e, ["x", "cx", "x1"]) || 0,
        ...
        (!c && "%" !== h) || (!ze[e] && !~e.indexOf("adius"))
          ? ((l[f ? "width" : "height"] = 100 + (_ ? h : i)),
            ...
            (s = a._gsap) && c && s.width && f && s.time === Ct.time
              ? ba((u / s.width) * 100)
              : ((!c && "%" !== h) || (l.position = ld(t, "position")),
                a === t && (l.position = "static"),
                a.appendChild(le),
                (n = le[p]),
                a.removeChild(le),
                (l.position = "absolute"),
                f && c && (((s = $(a)).time = Ct.time), (s.width = a[p])),
                ba(_ ? (n * u) / 100 : n && u ? (100 / n) * u : 0)))
  ...
  function yd(t, e, r, i) {
    ...
    if (
      ...
      (r += ""),
      "auto" == (i += "") &&
        ((t.style[e] = i), (i = ld(t, e) || i), (t.style[e] = r)),
      sb((s = [r, i])),
      (i = s[1]),
      (u = (r = s[0]).match(it) || []),
      (i.match(it) || []).length)
    ...
    if (e.tween && e.tween._time === e.tween._dur) {
      ...
      if ("all" === o || !0 === o) (s.cssText = ""), (i = 1);
        ...
        for (n = (o = o.split(",")).length; -1 < --n; )
          (r = o[n]),
            ze[r] && ((i = 1), (r = "transformOrigin" === r ? Ye : qe)),
            td(a, r);
      i &&
        (td(a, qe),
        u &&
  ...
  function Id(t, e, r, i, n, a) {
    ...
    r
      ? l !== Ge &&
        ...
        (x = u))
      : ((w = (s = rd(t)).x + (~T[0].indexOf("%") ? (w / 100) * s.width : w)),
  ...
  function Td(t, e, r) {
    ...
    ze))
      (a = f[n]) !== (s = i[n]) &&
        ...
        ((o = Na(a) !== (h = Na(s)) ? wd(r, n, a, h) : parseFloat(a)),
        (u = parseFloat(s)),
  ...
  var se,
    ...
    $e = function _parseTransform(t, e) {
      ...
      return (
        ...
        (m = Hd(t, r.svg)),
        r.svg &&
          ((P = !r.uncache && t.getAttribute("data-svg-origin")),
          Id(t, P || E, !!P || r.originIsAbsolute, !1 !== r.smooth, m)),
        (_ = r.xOrigin || 0),
        (c = r.yOrigin || 0),
        m !== Ge &&
          ((b = m[0]),
          ...
          6 === m.length
            ? ((s = Math.sqrt(b * b + T * T)),
              (o = Math.sqrt(x * x + w * w)),
              (u = b || T ? Re(T, b) * Fe : 0),
              (f = w || x ? Re(w, x) * Fe + u : 0) && (o *= Math.cos(f * Be)),
              r.svg && ((i -= _ - (_ * b + c * w)), (n -= c - (_ * T + c * x))))
            : ((B = m[6]),
              (z = m[7]),
              (A = m[8]),
              (S = m[9]),
              ...
              (u = (g = Re(T, b)) * Fe),
              g &&
                ((P = b * (v = Math.cos(g)) + T * (y = Math.sin(g))),
                (M = k * v + O * y),
                (T = T * v - b * y),
                (O = O * v - k * y),
                (b = P),
          ...
          r.svg &&
            ...
            (r.forceCSS = t.setAttribute("transform", "") || !Fd(ld(t, qe))),
        ...
        (r.zOrigin = parseFloat(E.split(" ")[2]) || 0) && (R[Ye] = Qe(E)),
    ...
    rr = function _renderSVGTransforms(t, e) {
      ...
      (d = parseFloat(d)),
        ...
        ((x && !~(l + "").indexOf("px")) || (k && !~(f + "").indexOf("px"))) &&
          ((x = wd(g, "x", l, "px")), (k = wd(g, "y", f, "px"))),
        (v || y || b || T) &&
          ((x = ba(x + v - (v * r + y * n) + b)),
          (k = ba(k + y - (v * i + y * a) + T))),
        (u || h) &&
          ((x = ba(x + (u / 100) * (s = g.getBBox()).width)),
    ...
    sr = {
      ...
      init: function init(t, e, r, i, n) {
        ...
        for (f in (he || od(), e))
          if (
            "autoRound" !== f &&
            ((s = e[f]), !ft[f] || !Pb(f, e, r, i, t, n))
          )
            if (
              ((h = typeof s),
              (l = Ke[f]),
              "function" === h && (h = typeof (s = s.call(r, i, t, n))),
              "string" === h && ~s.indexOf("random(") && (s = cb(s)),
              l)
            )
              l(this, t, f, s, r) && (y = 1);
                    ...
                    (s = Ad(s)),
                      g.svg
                        ...
                        : ((p = parseFloat(s.split(" ")[2]) || 0) !==
                            g.zOrigin && ud(this, g, "zOrigin", g.zOrigin, p),
                          ud(this, T, f, Qe(a), Qe(s)));
                    continue;
                  }
                  if ("svgOrigin" === f) {
                    Id(t, s, 1, v, 0, this);
              ...
              if (
                c ||
                ((o || 0 === o) && (u || 0 === u) && !Ee.test(s) && f in T)
              )
                (o = o || 0),
                  (d = (a + "").substr((u + "").length)) !==
                    (p = Na(s) || (f in Y.units ? Y.units[f] : d)) &&
                    (u = wd(t, f, a, p)),
                  (this._pt = new ie(
                    this._pt,
                    c ? g : T,
                    ...
                    u,
                    _ ? _ * o : o - u,
                    c || ("px" !== p && "zIndex" !== f) || !1 === e.autoRound
                      ? Xc
                      : $c
                  )),
                  (this._pt.u = p || 0),
                  d !== p && ((this._pt.b = a), (this._pt.r = Zc));
